...
public class PedicateExample {
    ...
    public static void main(String[] args) {
        ...
        Predicate<String> str1Pre = (str) -> str.isEmpty();
        ...
        System.out.println(((Predicate<String>) (str) -> str.isEmpty()).test(""));
        System.out.println(((Predicate<String>) (str) -> str.isEmpty()).test("java"));
        System.out.println("effeicient way  ended here.... \n");
