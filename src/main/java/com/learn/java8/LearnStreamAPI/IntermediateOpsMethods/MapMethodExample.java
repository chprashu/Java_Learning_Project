...
public class MapMethodExample {
    ...
    public static void main(String[] args) {
        ...
        You're given a list of IP addresses (IPv4) as List<String>. Some of these IPs belong to internal systems and need to be masked for logging purposes.
        Write a Java method that:
        Accepts a list of IP addresses.
        Masks each IP address by replacing the last octet with "***" (e.g., "192.168.0.100" becomes "192.168.0.***").
        Returns a new List<String> of the masked IPs using the Stream API and map() function.
         */
        ...
        You are given a list of IP addresses (IPv4), represented as a List<String>. Write a Java method that:
        ...
        No leading zeros unless the number is 0 (e.g., "01" is invalid, but "0" is valid).
         */
