...
public class ArrayListImpl {
    ...
    public static void main(String[] args) throws Exception {
        ...
        2. growth factor, a new array will create with size of 1.5 times the old array
        3. copying elements, when resizing occurs all elements of old array moved to new array
        ...
        list1.add(1);
        list1.add(1);
        list1.add(1); // till here it was storing elements in array which is created with initialCapacity 5
