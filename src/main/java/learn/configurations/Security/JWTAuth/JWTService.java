...
public class JWTService {
    ...
    /*
     * This takes secret key and derives a Key Object which is suitable for HMAC-SHA
     * signing (HS256, HS512, etc..)
     * The returned Key what you will pass to the signWith(...) while generating JWT
     * token
     */
     ...
     * token contains username, claims, issuedAt, expiry of the token as encrypted
     * string
     * with signature of signAlgorithm.HS256
     */
    public String generateToken(UserDetails userDetails) {
        /*
         * If any authorities are there of the logged User we set them as claims to JWT
         * token
         */
